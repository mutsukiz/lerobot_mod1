...
from .config_so_follower_mod1 import SOFollowerMOD1RobotConfig

logger = logging.getLogger(__name__)


class SOFollowerMOD1Robot(Robot):
    """
    ...
    config_class = SOFollowerMOD1RobotConfig
    name = "so_follower_mod1"

    def __init__(self, config: SOFollowerMOD1RobotConfig):
